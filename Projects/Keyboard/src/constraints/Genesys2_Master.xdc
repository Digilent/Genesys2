...
set_property -dict { PACKAGE_PIN AD23  IOSTANDARD LVCMOS33  PULLUP true } [get_ports { PS2Clk }]; #IO_L12P_T1_MRCC_12 Sch=ps2_clk[0]
set_property -dict { PACKAGE_PIN AE20  IOSTANDARD LVCMOS33  PULLUP true } [get_ports { PS2Data }]; #IO_25_12 Sch=ps2_data[0]
