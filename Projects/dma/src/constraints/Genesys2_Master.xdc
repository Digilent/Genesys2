...
# Audio Codec
set_property -dict { PACKAGE_PIN AH19  IOSTANDARD LVCMOS18 } [get_ports { SDATA_I }]; #IO_L8N_T1_32 Sch=aud_adc_sdata
...
set_property -dict { PACKAGE_PIN AG18  IOSTANDARD LVCMOS18 } [get_ports { BCLK_O }]; #IO_L11N_T1_SRCC_32 Sch=aud_bclk
set_property -dict { PACKAGE_PIN AJ19  IOSTANDARD LVCMOS18 } [get_ports { SDATA_O }]; #IO_L7P_T1_32 Sch=aud_dac_sdata
set_property -dict { PACKAGE_PIN AJ18  IOSTANDARD LVCMOS18 } [get_ports { LRCLK_O }]; #IO_L9P_T1_DQS_32 Sch=aud_lrclk
set_property -dict { PACKAGE_PIN AK19  IOSTANDARD LVCMOS18 } [get_ports { MCLK_O }]; #IO_L7N_T1_32 Sch=aud_mclk
set_property -dict { PACKAGE_PIN AE19  IOSTANDARD LVCMOS18 } [get_ports { iic_bus_scl_io }]; #IO_L10N_T1_32 Sch=aud_scl
set_property -dict { PACKAGE_PIN AF18  IOSTANDARD LVCMOS18 } [get_ports { iic_bus_sda_io }]; #IO_L11P_T1_SRCC_32 Sch=aud_sda
