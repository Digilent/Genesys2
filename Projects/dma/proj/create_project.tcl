...
if {[string equal [get_runs -quiet synth_1] ""]} {
  create_run -name synth_1 -board_part "digilentinc.com:genesys2:part0:1.1" -flow {Vivado Synthesis 2015} -strategy "Flow_PerfOptimized_High" -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
  create_run -name impl_1 -board_part "digilentinc.com:genesys2:part0:1.1" -flow {Vivado Implementation 2015} -strategy "Vivado Implementation Defaults" -constrset constrs_1 -parent_run synth_1
} else {
